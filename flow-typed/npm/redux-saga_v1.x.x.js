// flow-typed signature: 7f3f6c43d9fc1f22b280b20940cf5959
...
declare module 'redux-saga' {
  ...
  declare export var eventChannel: <T>(subscribe: Subscribe<T>, buffer?: Buffer<T>) => EventChannel<T>;
  ...
  declare export var runSaga: {
    ...
    <A, S, R, T1, T2, Fn: (T1, T2) => Saga<R>>(options: RunSagaOptions<A, S>, saga: Fn, T1, T2): Task<R>,
    <A, S, R, T1, T2, T3, Fn: (T1, T2, T3) => Saga<R>>(options: RunSagaOptions<A, S>, saga: Fn, T1, T2, T3): Task<R>,
  ...
  declare export type SagaMiddleware<C: {}> = {
    ...
    run: {
      ...
      <R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5) => Saga<R>>(saga: Fn, T1, T2, T3, T4, T5): Task<R>,
      <R, T1, T2, T3, T4, T5, T6, Fn: (T1, T2, T3, T4, T5, T6) => Saga<R>>(saga: Fn, T1, T2, T3, T4, T5, T6): Task<R>,
  ...
  declare export type PutEffect<A: {}, C: PuttableChannel<*> | null, R: { resolve: true } | void> = IEffect<
    'PUT',
    $ReadOnly<{|
      action: A,
      channel: C,
  ...
  declare export type RaceEffect<R: { +[name: string]: Effect } | $ReadOnlyArray<Effect>> = IEffect<'RACE', R, true>;

  declare export type AllEffect = IEffect<'ALL', { +[name: string]: Effect } | $ReadOnlyArray<Effect>, true>;
...
declare module 'redux-saga/effects' {
  ...
  declare export var call: {
    ...
    <R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(Fn, T1, T2, T3, T4): CallEffect<null, Fn, [T1, T2, T3, T4]>,
    ...
    <Ctx, R, T1, T2, T3, Fn: (T1, T2, T3) => R>(cfn: [Ctx, Fn], T1, T2, T3): CallEffect<Ctx, Fn, [T1, T2, T3]>,
    ...
    <R, FnName: string, Fn: () => R, Ctx: { [FnName]: Fn }>(cfn: [Ctx, FnName]): CallEffect<Ctx, Fn, []>,
    <R, FnName: string, T1, Fn: T1 => R, Ctx: { [FnName]: Fn }>(cfn: [Ctx, FnName], T1): CallEffect<Ctx, Fn, [T1]>,
    ...
    <R, FnName: string, T1, T2, T3, T4, T5, T6, Fn: (T1, T2, T3, T4, T5, T6) => R, Ctx: { [FnName]: Fn }>(
      cfn: [Ctx, FnName],
      T1,
      T2,
      T3,
    ...
    <R, FnName: string, T1, T2, T3, T4, T5, T6, T7, Fn: (T1, T2, T3, T4, T5, T6, T7) => R, Ctx: { [FnName]: Fn }>(
      cfn: [Ctx, FnName],
      T1,
      T2,
      T3,
    ...
    <Ctx, R, T1, T2, Fn: (T1, T2) => R>(cfn: { context: Ctx, fn: Fn }, T1, T2): CallEffect<Ctx, Fn, [T1, T2]>,
  ...
  declare export var apply: {
    ...
    <Ctx, R, T1, T2, T3, Fn: (T1, T2, T3) => R>(Ctx, Fn, T1, T2, T3): CallEffect<Ctx, Fn, [T1, T2, T3]>,
    <Ctx, R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(Ctx, Fn, T1, T2, T3, T4): CallEffect<Ctx, Fn, [T1, T2, T3, T4]>,
    <Ctx, R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5) => R>(
      Ctx,
      Fn,
      T1,
  ...
  declare export var cps: {
    ...
    <R, T1, T2, T3, Fn: (T1, T2, T3, NodeCallback<R>) => void>(Fn, T1, T2, T3): CpsEffect<null, Fn, [T1, T2, T3]>,
    ...
    <R, T1, T2, T3, T4, T5, T6, T7, T8, Fn: (T1, T2, T3, T4, T5, T6, T7, T8, NodeCallback<R>) => void>(
      Fn,
      T1,
      T2,
      T3,
    ...
    <Ctx, R, T1, T2, Fn: (T1, T2, NodeCallback<R>) => void>(cfn: [Ctx, Fn], T1, T2): CpsEffect<Ctx, Fn, [T1, T2]>,
    ...
    <Ctx, R, T1, T2, T3, T4, T5, T6, T7, T8, Fn: (T1, T2, T3, T4, T5, T6, T7, T8, NodeCallback<R>) => void>(
      cfn: [Ctx, Fn],
      T1,
      T2,
      T3,
    ...
    <Ctx, R, T1, Fn: (T1, NodeCallback<R>) => void>(cfn: { context: Ctx, fn: Fn }, T1): CpsEffect<Ctx, Fn, [T1]>,
  ...
  declare export var fork: {
    ...
    <R, T1, T2, T3, Fn: (T1, T2, T3) => R>(Fn, T1, T2, T3): ForkEffect<null, Fn, void, [T1, T2, T3]>,
    <R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(Fn, T1, T2, T3, T4): ForkEffect<null, Fn, void, [T1, T2, T3, T4]>,
    <R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5) => R>(
      Fn,
      T1,
      T2,
    ...
    <Ctx, R, T1, T2, Fn: (T1, T2) => R>(cfn: [Ctx, Fn], T1, T2): ForkEffect<Ctx, Fn, void, [T1, T2]>,
    <Ctx, R, T1, T2, T3, Fn: (T1, T2, T3) => R>(cfn: [Ctx, Fn], T1, T2, T3): ForkEffect<Ctx, Fn, void, [T1, T2, T3]>,
    <Ctx, R, T1, T2, T3, T4, Fn: (T1, T2, T3, T4) => R>(
      cfn: [Ctx, Fn],
      T1,
      T2,
    ...
    <Ctx, R, T1, T2, Fn: (T1, T2) => R>(cfn: { context: Ctx, fn: Fn }, T1, T2): ForkEffect<Ctx, Fn, void, [T1, T2]>,
    <Ctx, R, T1, T2, T3, Fn: (T1, T2, T3) => R>(
      cfn: { context: Ctx, fn: Fn },
      T1,
      T2,
  ...
  declare export var spawn: {
    ...
    <R, T1, T2, T3, Fn: (T1, T2, T3) => R>(Fn, T1, T2, T3): ForkEffect<null, Fn, { detached: true }, [T1, T2, T3]>,
    ...
    <Ctx, R, T1, T2, Fn: (T1, T2) => R>(cfn: [Ctx, Fn], T1, T2): ForkEffect<Ctx, Fn, { detached: true }, [T1, T2]>,
    <Ctx, R, T1, T2, T3, Fn: (T1, T2, T3) => R>(
      cfn: [Ctx, Fn],
      T1,
      T2,
  ...
  declare export var select: {
    ...
    <S, R, T1, T2, T3, T4, Fn: (S, T1, T2, T3, T4) => R>(Fn, T1, T2, T3, T4): SelectEffect<Fn, [T1, T2, T3, T4]>,
  ...
  declare export var takeEvery: {
    ...
    <A, R, P: TakeableChannel<*> | Pattern, T1, Fn: (T1, A) => R>(P, Fn, T1): ForkEffect<null, Fn, void, [P, Fn, T1]>,
    ...
    <A, R, P: TakeableChannel<*> | Pattern, T1, T2, T3, T4, T5, T6, T7, Fn: (T1, T2, T3, T4, T5, T6, T7, A) => R>(
      P,
      Fn,
      T1,
      T2,
  ...
  declare export var throttle: {
    ...
    <MS: number, P: TakeableChannel<*> | Pattern, A, R, Fn: A => R>(MS, P, Fn): ForkEffect<null, Fn, void, [MS, P, Fn]>,
    ...
    <MS: number, P: TakeableChannel<*> | Pattern, A, R, T1, T2, T3, T4, T5, Fn: (T1, T2, T3, T4, T5, A) => R>(
      MS,
      P,
      Fn,
      T1,
    ...
    <MS: number, P: TakeableChannel<*> | Pattern, A, R, T1, T2, T3, T4, T5, T6, Fn: (T1, T2, T3, T4, T5, T6, A) => R>(
      MS,
      P,
      Fn,
      T1,
  ...
  declare export var debounce: {
    ...
    <R, MS: number, P: TakeableChannel<*> | Pattern, Fn: () => R>(MS, P, Fn): ForkEffect<null, Fn, void, [MS, P, Fn]>,
    ...
    <R, MS: number, P: TakeableChannel<*> | Pattern, T1, T2, T3, T4, T5, T6, Fn: (T1, T2, T3, T4, T5, T6) => R>(
      MS,
      P,
      Fn,
      T1,
    ...
    <R, MS: number, P: TakeableChannel<*> | Pattern, T1, T2, T3, T4, T5, T6, T7, Fn: (T1, T2, T3, T4, T5, T6, T7) => R>(
      MS,
      P,
      Fn,
      T1,
  ...
  declare export var retry: {
    ...
    <R, MT: number, D: number, T1, Fn: T1 => R>(MT, D, Fn, T1): CallEffect<null, Function, [MT, D, Fn, T1]>,
    ...
    <R, MT: number, D: number, T1, T2, T3, T4, T5, T6, T7, T8, Fn: (T1, T2, T3, T4, T5, T6, T7, T8) => R>(
      MT,
      D,
      Fn,
      T1,
